...
var FlipbookView = SingleView.extend({
  ...
  _getPageElement: function(pageNumber) {
    var $el = $('<div />'),
      ...
      imgSrc = settings.pageFolder+'/'+pageNumber+'.jpg',
...
//    return FlipbookSettings.pageFolder + this.pageNumber + '/regions.json';
    return FlipbookSettings.pageFolder + 'regions.json';
  },
...
var OptionsView = SingleView.extend({
  ...
  _tapIcon: function(event) {
    ...
    switch ($icon.attr('id')) {
      ...
      break;
      case 'ui-icon-language':
        LanguageBox.getInstance().show();
      break;
      case 'ui-icon-share':
...
var LanguageBox = SingleView.extend({
  className: 'ui-language-box',
  tagName: 'div',
  events: {
    'tap': '_tapEvent',
  ...
  initialize: function() {
    ...
    html +='<div class="ui-language-options">';
      html +='<a title="Korean" class="ui-icon show-hint"><i class="lagnBtn lang-kr"></i></a>';
      html +='<a title="English" class="ui-icon show-hint"><i class="lagnBtn lang-en"></i></a>';
      html +='<a title="Japanese" class="ui-icon show-hint"><i class="lagnBtn lang-jp"></i></a>';
    html +='</div>';
  ...
  _tapIconEvent: function(event) {
    ...
    switch (title) {
      case 'Korean':
        window.location = 'http://www.boxcoop.co.kr/data/skin/ebook/yk-kr/magazine.html';
      break;
      case 'English':
        window.location = 'http://www.boxcoop.co.kr/data/skin/ebook/yk-en/magazine.html';
      break;
      case 'Japanese':
        window.location = 'http://www.boxcoop.co.kr/data/skin/ebook/yk-jp/magazine.html';
      break;
    }
  ...
  show: function() {
    var that = this;
    setTimeout(function() {
      that.$el.addClass('show-ui-language-box');
    }, 1);
  },

  hide: function() {
    this.$el.removeClass('show-ui-language-box');
  }
});
...
var ShareBox = SingleView.extend({
  ...
  initialize: function() {
    ...
    html +='<div class="ui-share-options">';
      //html +='<a title="Facebook" class="ui-icon show-hint"><i class="fa-brands fa-facebook-square"></i></a>';
      html +='<a title="Twitter" class="ui-icon show-hint"><i class="fa-brands fa-twitter-square"></i></a>';
      html +='<a title="Google+" class="ui-icon show-hint"><i class="fa-brands fa-google-plus-square"></i></a>';
      html +='<a title="Linkedin" class="ui-icon show-hint"><i class="fa-brands fa-linkedin"></i></a>';
      html +='<a title="Email" class="ui-icon show-hint"><i class="fa fa-square-envelope"></i></a>';
    html +='</div>';
